...
**Optional:** After installing, open the script in your extension's editor and replace the first `*` at the start of the URL in the `// @match` line (usually line 4) with your clinic's subdomain. For example, if your clinic's Jane URL is `https://myclinic.janeapp.com`, the line should read:
```
